          ...
          <h1 class="title"><?php echo $dis_title; ?> <small>(<?php echo $otitle; ?> 문서 토론)</small>
			<section class="ddark-btn">
				<div class="btn-group pull-right" role="group" aria-label="content-tools">
					  <a href="/w/<?php echo urlencode($otitle); ?>" class="btn btn-sm btn-outline-secondary">문서</a>
					  <a href="/discuss/d/<?php echo urlencode($otitle); ?>" class="btn btn-sm btn-outline-secondary">토론 목록</a>
				</div>
			</section>
		  </h1>
		  <h3>열린 토론 목록</h3>
			  ...
			  <?php foreach ($query->result() as $row) { ?>
				<div class="card mt-2 mb-2">
					<div class="card-header" style="padding:.30rem 1rem;">
						<span id="ds-2" class="dwe-line">#<?php echo $row->c_id; ?></span> <?php echo $row->user; ?>
