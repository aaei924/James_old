<?php $this->load->view(skin."/".'_head'); ?>
        ...
        <style>
textarea.autosize { height: 400px; }
</style>


			  <textarea class="wiki-edit-form form-control autosize"  name="wtext"<?php if ($s_type == 'new') { ?> placeholder="작성할 내용을 입력하세요!"<?php } ?>><?php if ($s_type != 'new') { echo $text; } ?></textarea>
       <div class="py-1">
			  <label>편집 설명 : </label>
